...
export default function HeroSection() {
  return (
    <section className="mx-auto flex min-h-[calc(100svh-5rem)] lg:min-h-[calc(100svh-6.25rem)] max-w-7xl items-center justify-center px-5 sm:px-8 py-20 font-sans lg:px-12">
      <div className="mx-auto max-w-4xl text-center">
        <p className="mb-6 text-xs font-medium uppercase tracking-[0.14em] text-[#72757b]">
          Anabat · Independent video editor
        </p>
        ...
        <p className="mx-auto mt-8 max-w-xl text-base leading-7 text-[#72757b] md:text-lg">
          I’m Anabat. I edit videos with a focus on story, rhythm, and the
          details that make people keep watching.
        </p>
