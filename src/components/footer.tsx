...
export default function Footer() {
    return (
        <footer className="mx-auto max-w-7xl overflow-hidden pt-10 font-[Manrope,Arial,sans-serif] text-[#252525]">
            <div className="grid gap-10 px-6 pb-10 md:grid-cols-[1.5fr_1fr] md:gap-16 md:px-12">
                <div>
                    ...
                    <p className="mt-4 max-w-sm text-sm leading-6 text-[#72757b]">
                        Have footage ready or an idea taking shape? Tell me what
                        you’re working on, and let’s find the story in it.
                    </p>
                    <Link
                        href="/contact"
                    ...
                    >
                        ...
                        <span aria-hidden="true" className="transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5 motion-reduce:transform-none">↗</span>
                    </Link>
                </div>
                ...
                >
                    ...
                    <p className="mt-8 max-w-xs text-sm leading-6 text-[#72757b]">
                        Independent editing. Intentional storytelling.
                        Thoughtful cuts, color, and sound—from the first frame
                        to the final feeling.
                    </p>
                </div>
            </div>

            <div className="flex flex-col gap-4 px-6 pt-6 text-xs text-[#72757b] sm:flex-row sm:items-center sm:justify-between md:px-12">
                <span>
                    © {new Date().getFullYear()} Anabat. All rights reserved.
                </span>
            ...
            <Link
                ...
                className="mt-8 block w-full px-6 pb-6 md:px-12"
            >
                <svg
                ...
                >
                    <defs>
                        ...
                        <mask id="footer-wordmark-mask">
                            <rect width="1000" height="220" fill="url(#footer-wordmark-fade)" />
                        </mask>
                    </defs>
